...
void HRocker::touchEvent(){
	...
	auto touchListener = EventListenerTouchOneByOne::create();//增加之处
	...
	//this->getEventDispatcher()->addEventListenerWithSceneGraphPriority(touchListener, this);//修改之处
}
...
void HRocker::startRocker(bool _isStopOther,EventListener* listener)
{
	...
	auto touchListener = EventListenerTouchOneByOne::create();//增加之处
	this->getEventDispatcher()->addEventListenerWithSceneGraphPriority(listener,this);//修改之处
